...
MCM = ()=>{
    const oferta = [oferta1.value,oferta2.value,oferta3.value];
    const demanda = [demanda1.value,demanda2.value,demanda3.value];
    const costo = [c1.value,c2.value,c3.value,c4.value,c5.value,c6.value,c7.value,c8.value,c9.value];

    let costos = [c1.value,c2.value,c3.value,c4.value,c5.value,c6.value,c7.value,c8.value,c9.value]
