function metodCM() {
    ...
    demanda = [1600,1400,1500]
    const costo = [30,15,20,10,25,30,25,30,15];

    let costos = [30,15,20,10,25,30,25,30,15];
    let costoMenor = costos.sort((a,b)=> a - b)

    if ((oferta[0]+oferta[1]+oferta[2]) == (demanda[0]+demanda[1]+demanda[2])) {
        let resultadoTotal = ""
        ...
        let resultado = eval(resultadoTotal);
        return resultado;
    }
    else{
        return "Ingrese una operacion valida. La oferta y la demanda deben ser iguales."
    }
}
